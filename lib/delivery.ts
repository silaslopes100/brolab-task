...
// Central de entrega de notificações: e-mail + Telegram + Push (PWA/FCM).
// Nunca lança: falhas de delivery não podem quebrar o fluxo principal.
export async function dispatchNotification(payload: NotificationPayload): Promise<void> {
  ...
  try {
    ...
    // Push nativo (PWA / FCM): envia quando o usuário tem inscrição ativa
    promises.push(
      sendPushToUser(
        supabase,
        user.id,
